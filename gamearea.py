...
class GameArea():
    ...
    def draw(self, score, is_gameover, session_count, is_paused):
        '''绘制游戏区域，即20*10的游戏区域'''
    ...
    def draw_pause(self):
        ...
        self.screen.blit(pause_surface, pause_position)
        self.screen.blit(resume_tip_surface, resume_tip_position)
